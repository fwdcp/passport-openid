 ...
 *
 * Options:
 *   - `returnURL`         URL to which the OpenID provider will redirect the user after authentication (value or function(req))
 *   - `realm`             the part of URL-space for which an OpenID authentication request is valid (value or function(req))
